...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#224DFF' : '#224DFF',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#224DFF',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#737373' : '#bfc6ea',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  sTabBarActiveTextColor: '#224DFF',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#2874F0' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#224DFF',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#224DFF',
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? '#CECDD2' : '#fff',
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  iosStatusbar: 'dark-content',
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#224DFF',
  get statusBarColor() {
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#224DFF' : '#224DFF',
  ...
  radioSelectedColorAndroid: '#224DFF',
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#224DFF',
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#224DFF',
  segmentBorderColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#224DFF',
  ...
  // Tab
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#224DFF',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#b3c7f9',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#224DFF' : '#fff',
