...
export default {
  ...
  tabActiveBgColor: '#224DFF',

  // Header
  toolbarBtnColor: "#224DFF",
  toolbarDefaultBg: "#224DFF",
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#224DFF' : '#224DFF',
  ...
  segmentActiveBackgroundColor: '#224DFF',
  segmentTextColor: '#224DFF',
  segmentActiveTextColor: '#fff',
  segmentBorderColor: '#224DFF',
  ...
  topTabBarActiveTextColor: '#224DFF',
  topTabBarBorderColor: '#a7a6ab',
  topTabBarActiveBorderColor: '#224DFF',
