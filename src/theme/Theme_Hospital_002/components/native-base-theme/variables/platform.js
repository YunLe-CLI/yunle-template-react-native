...
export default {
  ...
  tabActiveBgColor: '#5277F1',

  // Header
  toolbarBtnColor: "#5277F1",
  toolbarDefaultBg: "#5277F1",
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#5277F1' : '#5277F1',
  ...
  segmentActiveBackgroundColor: '#5277F1',
  segmentTextColor: '#5277F1',
  segmentActiveTextColor: '#fff',
  segmentBorderColor: '#5277F1',
  ...
  topTabBarActiveTextColor: '#5277F1',
  topTabBarBorderColor: '#a7a6ab',
  topTabBarActiveBorderColor: '#5277F1',
