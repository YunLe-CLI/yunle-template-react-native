...
import logoImg from './assets/logo_class_slices/logo_jycj.png';
                ...
                <View style={{
                  ...
                  <View>
                    <Form style={{
                      ...
                      <Item style={styles.iptItem}>
                        <Input value={this.state.loginName} style={styles.ipt} placeholder="请输入账号" placeholderTextColor={"#9C9EB9"}
                               onChangeText={(value) => {
                                 this.setState({
                                   loginName: value,
                                 })
                  ...
                  <View style={styles.btnWrap}>
                    <LinearGradient
                      ...
                      colors={this.state.password && this.state.loginName ? ['#29EFDE', '#4712DB'] : ['#D8D8D8', '#D8D8D8']}
                      style={[
