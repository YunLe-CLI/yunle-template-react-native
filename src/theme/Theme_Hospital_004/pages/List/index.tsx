...
class Home extends React.Component<IProps, IState> {
        ...
        <View style={styles.itemBoxContent}>
          <View style={{
            ...
            <ImageBackground 
              ...
              source={require('./assets/typeBg/index.png')}
            > 
          ...
          <Text style={styles.itemBodyTitle}>
            {data.medicalDepartment} {data.name} {data.professionalTitle}
          </Text>
          ...
          <View style={[styles.itemBoxFooter]}>
            {
              data.position >= 0 ? (
                <Text numberOfLines={2} style={[styles.itemBodyText]}>
                  前面还有
                  <Text style={[styles.itemBodyText]}>{data.position}</Text>
                  人
                </Text>
              ) : undefined
            }
  ...
  renderTabList() {
    ...
    if (params.title === '今日预约') {
      list = [
        todayList,
      ]
    }
    if (params.title === '全部预约') {
      list = [
        registrationsList,
      ]
    }
    ...
    return (
      <Container style={styles.container}>
        ...
        >
            ...
            <Body>
                <Title style={{ color: '#333333' }}>{params.title}</Title>
            </Body>
            <Right />
        </Header>
        <View
