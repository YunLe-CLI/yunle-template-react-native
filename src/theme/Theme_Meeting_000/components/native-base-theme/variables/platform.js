...
export default {
  ...
  tabActiveBgColor: '#8AC3F5',

  // Header
  toolbarBtnColor: "#118DF0",
  toolbarDefaultBg: "#118DF0",
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#118DF0' : '#118DF0',
  ...
  segmentActiveBackgroundColor: '#118DF0',
  segmentTextColor: '#118DF0',
  segmentActiveTextColor: '#fff',
  segmentBorderColor: '#118DF0',
  ...
  topTabBarActiveTextColor: '#118DF0',
  topTabBarBorderColor: '#a7a6ab',
  topTabBarActiveBorderColor: '#118DF0',
