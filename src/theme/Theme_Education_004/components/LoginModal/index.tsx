          ...
          <View style={{ flex: 1 }}>
            ...
            <ImageBackground style={{ flex: 1,
              ...
              backgroundColor: '#01000B'
                             ...
                             source={require('./assets/login_bg/login_bg.png')}
            >
                ...
                >
                  <View style={{
                    ...
                    <View style={styles.logoWrap}>
                      <Text style={styles.logoText}>教育课堂登录</Text>
                    </View>
                    <View>
                      <Form>
                        <Item style={styles.iptItem}>
                          <Input value={this.state.loginName} style={styles.ipt} placeholder="请输入用户名" placeholderTextColor={"#FFFFFF"}
                                 onChangeText={(value) => {
                                   this.setState({
                                     loginName: value,
                                   })
                        ...
                        <Item style={styles.iptItem}>
                          <Input secureTextEntry value={this.state.password} style={styles.ipt} placeholder="请输入密码" placeholderTextColor={"#FFFFFF"}
                                 onChangeText={(value) => {
                                   this.setState({
                                     password: value,
                                   })
