...
import { sliderWidth, itemWidth } from '@/components/CarouselDemo/styles/SliderEntry.style';
import SliderEntry from '@/components/CarouselDemo/components/SliderEntry';
import styles, { colors } from '@/components/CarouselDemo/styles/index.style';
import { ENTRIES1, ENTRIES2 } from '@/components/CarouselDemo/static/entries';
import { scrollInterpolators, animatedStyles } from '@/components/CarouselDemo/utils/animations';
            ...
            <View style={styles.safeArea}>
                <View style={styles.container}>
                    <Header
                        ...
                        centerComponent={{ text: '走马灯', style: { color: '#fff' } }}
                    />
                    <StatusBar
                      translucent={true}
